...
public class HeroesController {
	...
	private final String HEROES_ENDPOINT_LOCAL = "/heroes";
	...
	public Mono<ResponseEntity<Heroes>> findByIdHero(@PathVariable int id) {
	...
	public Mono<HttpStatus> deletebyIDHero(@PathVariable int id) {
